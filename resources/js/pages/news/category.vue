      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center py-4">
          ...
          <div class="flex items-center space-x-4">
            ...
            <div>
              <h1 class="text-2xl font-bold gradient-text-blue">Portal de Notícias</h1>
          ...
          <div class="hidden md:flex items-center space-x-3">
            ...
            <a href="/news" class="btn-secondary hover-scale">
              <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="md:hidden" :class="mobileMenuOpen ? 'block' : 'hidden'">
          <div class="py-4 border-t border-gray-200/50">
            ...
            <div class="mt-4 pt-4 border-t border-gray-200/50">
              ...
              <a href="/news" class="text-gray-600 px-3 py-2 text-sm font-medium hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-colors block mt-2">
                Voltar ao Início
              </a>
            </div>
          </div>
      ...
      <div v-if="categoryNews && categoryNews.success && categoryNews.articles && categoryNews.articles.length > 0" class="mb-16">
        <div class="space-y-8">
          <article 
            ...
            :key="article.url"
            class="bg-white/80 backdrop-blur-sm border border-gray-200/50 rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 fade-in-up"
          >
            <div class="flex gap-6">
              <div class="flex-1">
                ...
                <h4 class="text-xl font-bold text-gray-900 mb-3 leading-tight hover:text-blue-600 transition-colors">
